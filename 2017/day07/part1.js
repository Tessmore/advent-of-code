...
while (counter < nodes.length) {
    ...
    for (var i=1; i < nodes.length; i++) {
        ...
        if (node.supporting.indexOf(toFind) >= 0) {
            node.supporting = node.supporting.concat(nodes[counter].supporting);
            nodes[counter] = null;
            break;
        }
    }
...
console.log(nodes.filter(n => n !== null))
